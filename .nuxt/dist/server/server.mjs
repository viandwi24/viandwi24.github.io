...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/blog-wyr-b3t2.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-Gvr-nhjD.js").then((m) => m.default || m)
  },
  {
    name: "experience",
    path: "/experience",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/index-Bu1-_68-.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
...
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-HSg-OzDh.js").then((r) => r.default));
