import { hasInjectionContext, getCurrentInstance, effectScope, reactive, version, unref, inject, ref, watchEffect, watch, toRef, h, nextTick, shallowRef, shallowReactive, isReadonly, isRef, markRaw, toRaw, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, isShallow, defineAsyncComponent, defineComponent, provide, Suspense, mergeProps, Transition, withAsyncContext, createVNode, resolveDynamicComponent, useSSRContext, withCtx, openBlock, createBlock, createCommentVNode, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-ZiUGxYKI.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-iraO2ynO.js").then((m) => m.default || m)
  },
  {
    name: "experience",
    path: "/experience",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/experience-dCFcHeMX.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-T7QW3tpb.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/projects-wty2tS-t.js").then((m) => m.default || m)
  }
];
...
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-6w5dj2Fj.js").then((r) => r.default));
...
const layouts = {
  default: () => import("./_nuxt/default-6CRy17Xk.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-SqtV27RL.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-PK48G038.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
