        ...
        <div class="wrapper-with-tag">
          <div class="container-with-tag" style="--tag: 'h1';">
            ...
            <div class="mb-4 flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 font-mono justify-start items-start">
              <NuxtLink to="about" class="w-auto flex items-center px-4 py-2 rounded bg-blue-400 sm:flex space-x-1">
              ...
              <a href="https://github.com/viandwi24" target="_blank" class="w-auto flex items-center px-4 py-2 rounded bg-gray-700 sm:flex space-x-1">
