  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "about",
        class: "w-auto flex items-center px-4 py-2 rounded bg-blue-400 sm:flex space-x-1"
      }, {
      ...
      _push(`<span>Linktr.ee</span></a><a href="https://github.com/viandwi24" target="_blank" class="w-auto flex items-center px-4 py-2 rounded bg-gray-700 sm:flex space-x-1">`);
...
//# sourceMappingURL=index-ksK9Gock.mjs.map
