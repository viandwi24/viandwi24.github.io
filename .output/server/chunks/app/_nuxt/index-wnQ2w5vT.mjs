...
import { a as useSeoMeta, b as useLoading, h as __nuxt_component_1 } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<a href="https://linktr.ee/viandwi24" target="_blank" class="w-auto flex items-center px-4 py-2 rounded bg-green-400 sm:flex space-x-1">`);
      _push(ssrRenderComponent(_component_Icon, { name: "mdi:pine-tree-variant-outline" }, null, _parent));
      _push(`<span>Linktr.ee</span></a><a href="https://github.com/viandwi24" target="_blank" class="w-auto flex items-center px-4 py-2 rounded bg-gray-600 sm:flex space-x-1">`);
...
//# sourceMappingURL=index-wnQ2w5vT.mjs.map
