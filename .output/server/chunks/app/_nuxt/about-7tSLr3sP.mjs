...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`. </p></div><div class="w-full lg:w-1/4 lg:pl-4 flex justify-center items-center lg:justify-end flex-1 mb-4 lg:mb-0"><div class="relative mypic-wrapper">`);
...
//# sourceMappingURL=about-7tSLr3sP.mjs.map
