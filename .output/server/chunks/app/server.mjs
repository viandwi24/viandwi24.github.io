...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-jexLCaSt.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/experience-JXiHGTNZ.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-TExAKtQa.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default--QSVG4mi.mjs').then((m) => m.default || m)
};
...
export { _export_sfc as _, useSeoMeta as a, useLoading as b, createError as c, asyncDataDefaults as d, entry$1 as default, useNuxtApp as e, fetchDefaults as f, useRequestFetch as g, __nuxt_component_1 as h, useRequestEvent as i, useRuntimeConfig as j, useAppConfig as k, useRouter as l, navigateTo as m, nuxtLinkDefaults as n, resolveIconName as r, useHead as u };
