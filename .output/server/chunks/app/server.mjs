import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, defineAsyncComponent, defineComponent, h, inject, computed, unref, provide, useSSRContext, shallowReactive, Suspense, nextTick, Transition, mergeProps, withAsyncContext, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, createCommentVNode, createApp, effectScope, reactive, toRef, isRef, isReactive, toRaw, onErrorCaptured, onServerPrefetch, shallowRef, isReadonly, getCurrentScope, onScopeDispose, markRaw, toRefs, isShallow } from 'vue';
import { a as useRuntimeConfig$1, $ as $fetch, w as withQuery, n as hasProtocol, p as parseURL, o as isScriptProtocol, j as joinURL, k as createError$1, q as klona, r as defu, t as sanitizeStatusCode, v as defuFn, x as createHooks } from '../nitro/node-server.mjs';
import { getActiveHead } from 'unhead';
import { defineHeadPlugin, composableNames, unpackMeta } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-8fXgULP_.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contact-mBT6XEKW.mjs').then((m) => m.default || m)
  },
  {
    name: "experience",
    path: "/experience",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/experience-e9gYRGLr.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-rNH2uNlG.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-loArPVFT.mjs').then((m) => m.default || m)
  }
];
...
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-HSg-OzDh.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-C8ttHxY3.mjs').then((m) => m.default || m)
};
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref($loading).$state.isLoading) {
              _push2(`<div class="fixed w-screen h-screen bg-gray-950/90 flex items-center justify-center text-gray-100 z-[60]"${_scopeId}><div class="flex flex-col items-center justify-center gap-4"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "eos-icons:loading",
                class: "text-6xl"
              }, null, _parent2, _scopeId));
              _push2(`<div${_scopeId}>Loading Assets</div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              unref($loading).$state.isLoading ? (openBlock(), createBlock("div", {
                key: 0,
                class: "fixed w-screen h-screen bg-gray-950/90 flex items-center justify-center text-gray-100 z-[60]"
              }, [
                createVNode("div", { class: "flex flex-col items-center justify-center gap-4" }, [
                  ...
                  createVNode("div", null, "Loading Assets")
                ])
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-ch8c65_E.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-_DdEEOsb.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-PK48G038.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useSeoMeta as a, useLoading as b, createError as c, asyncDataDefaults as d, entry$1 as default, useNuxtApp as e, fetchDefaults as f, useRequestFetch as g, __nuxt_component_0 as h, useRequestEvent as i, useRuntimeConfig as j, useAppConfig as k, useRouter as l, navigateTo as m, nuxtLinkDefaults as n, resolveIconName as r, useHead as u };
